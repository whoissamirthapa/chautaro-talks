...
function Signup() {
    ...
    const submitForm = (e) =>{
        ...
        axios.post("http://localhost:4000/user/sign-up", data)
        .then(response=>{
    ...
    return (
        <section className={ `${classes.signup_form_parent_container}`}>
            <header className={classes.title__singup}>Create Your Account</header>
            <form onSubmit={submitForm}>
                <div className={classes.signup__name}>
                    ...
                    /> 
                    { !validName && 
                        <p className={classes.invalid_signup_data}>Name is not valid</p>
                    }
                </div>
                ...
                <div className={classes.signup__email}>
                    ...
                    /> 
                    { !validEmail && 
                        <p className={classes.invalid_signup_data}>Email is not valid</p>
                    }
                </div>
                <div>Gender</div>
                <div className={classes.signup__gender} >
                    ...
                    { !validGender && 
                        <p className={classes.invalid_signup_data}>Gender is not selected</p>
                    }
                </div>
                ...
                <div className={classes.signup__address}>
                    ...
                    <span className={classes.input_icon_field}>
                        <i className={`fas fa-map-marker-alt ${classes.input__icon}`}></i>
                    </span>
                    <input 
                        type="text" 
                        ref={addressRef} 
                    ...
                    /> 
                    { !validAddress && 
                        <p className={classes.invalid_signup_data}>Address is not valid</p>
                    }
                </div>
                ...
                <div className={classes.signup__password}>
                    ...
                    /> 
                    { !validPassword && 
                        <p className={classes.invalid_signup_data}>Password should not less than 6</p>
                    }
                </div>
                ...
                <div className={classes.signup__cpassword}>
                    ...
                    /> 
                    { !validCpassword && 
                        <p className={classes.invalid_signup_data}>Password not matched</p>
                    }
                </div>
